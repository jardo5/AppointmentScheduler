...
public class AppSQL {
    ...
    public static LocalDateTime localToEST(LocalDateTime localDateTime) {
        ZonedDateTime localZDT = localDateTime.atZone(ZoneId.of(ZoneId.systemDefault().toString()));
        ZonedDateTime estZDT = localZDT.withZoneSameInstant(ZoneId.of("America/New_York"));
    ...
    public static ObservableList<Appointments> getAppointmentsContacts(int contactId) throws SQLException {
        ObservableList<Appointments> appointmentList = FXCollections.observableArrayList();
        Connection conn = JDBC.connection;
    ...
    public static void addAppointment(int tempID, String tempTitle, String tempDescription, String tempLocation, int tempContactID, String tempType, LocalDateTime tempStart, LocalDateTime tempEnd, int tempCustomerID, int tempUserID) {
        try {
            Connection conn = JDBC.connection;
            String sql = "INSERT INTO appointments (Appointment_ID, Title, Description, Location, Contact_ID, Type, Start, End, Create_Date, Created_By, Last_Update, Last_Updated_By, Customer_ID, User_ID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, NOW(), ?, ?, ?)";
            PreparedStatement statement = conn.prepareStatement(sql);
