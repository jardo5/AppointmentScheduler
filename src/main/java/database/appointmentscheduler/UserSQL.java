...
public class UserSQL {
    ...
    public static Users loggedUser(String userName, String password) throws SQLException {
        String query = "SELECT * FROM users WHERE User_Name = ? AND BINARY Password = ? LIMIT 1";
        try (PreparedStatement statement = Query.createQuery(query)) {
